    ...
    <section id="specjalizacje" className="md:container">
      <div>
        ...
        <div className="flex justify-between w-[80%] mx-auto">
          {/* LEFT */}
          <div className="font-libre flex flex-col flex-[50%]">
            <div className="w-[90%]">
              <h1 className="text-xl font-bold mb-6">Inżynieria</h1>
            ...
            <div className="mt-6 w-[90%]">
              <h1 className="text-xl font-bold mb-6">Agromelioracja</h1>
              <p className="text-[15px] font-sans">
            ...
            <div className="mt-6 w-[90%]">
              <h1 className="text-xl font-bold mb-6">Rewitalizacja</h1>
              <p className="text-[15px] font-sans">
